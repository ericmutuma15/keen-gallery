...
const seed = async () => {
  ...
  const artworks = [
    { title: 'Machakos Light', categoryId: categories[0].id, subcategoryId: paintingSubs[1].id, imageUrl: 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?auto=format&fit=crop&w=1200&q=80', year: 2026, medium: 'Digital portrait', dimensions: '90 x 120 cm', price: 2200, availability: 'Available', featured: true },
    { title: 'After Rain', categoryId: categories[0].id, subcategoryId: paintingSubs[0].id, imageUrl: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?auto=format&fit=crop&w=1200&q=80', year: 2026, medium: 'Mixed media', dimensions: '100 x 80 cm', price: 2600, availability: 'Available', featured: true },
